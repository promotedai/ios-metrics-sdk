...
public struct Delivery_DeliveryLog {
  ...
  public var request: PromotedAIMetricsSDK.Delivery_Request {
    get {return _request ?? PromotedAIMetricsSDK.Delivery_Request()}
  ...
  public var response: PromotedAIMetricsSDK.Delivery_Response {
    get {return _response ?? PromotedAIMetricsSDK.Delivery_Response()}
  ...
  fileprivate var _request: PromotedAIMetricsSDK.Delivery_Request? = nil
  fileprivate var _response: PromotedAIMetricsSDK.Delivery_Response? = nil
